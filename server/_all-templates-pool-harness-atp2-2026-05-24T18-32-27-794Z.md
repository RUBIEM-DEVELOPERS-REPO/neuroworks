# All-templates harness w/ pool scaling :: atp2 :: 2026-05-24T18:16:53.252Z
...
Pre-burst pool: count=1/3; primary inflight=0; peers=secondary@7473(0)
  ── 6 burst tasks dispatched in 6.1s
     dispatch routing: primary, primary, primary, primary, peer@7473, peer@7473
  ── pool growth during 30s burst window:
     t+0.1s: pool=1 peers=1 primaryInflight=6
  ── final pool: count=1/3 (started at 1)
  ── draining 6 burst jobs…
  ── drain done in 142.0s; 6/6 succeeded
...
| Phase B | 3/3 | 3 | 80 | (none) |
| Phase C | 1/3 | 8 | 139 | 0→1 |
| OVERALL | 3/3 | 50 | 219 | 3→0, 0→1 |

## Phase B scorecard

| template | role | target | elapsed | content | time | FINAL |
|---|---|---|---|---|---|---|
| summarize-repo | Engineering | 120s | 63.4s | A | 0 | **A** |
| run-digest | Engineering | 60s | 6s | A | 0 | **A** |
...
| general-task | Insights | 90s | 90.4s | A | 0 | **A** |
| sync-downloads | Knowledge | 120s | 0s | A | 0 | **A** |
| custom-give-me-a-report-on-the-r-d-ai-research-project-in-my | Custom | 150s | 21.2s | A- | 0 | **A-** |
| custom-what-is-in-the-readme-of-the-clawbot-repo-on-github | Custom | 150s | 30.1s | A- | 0 | **A-** |
| custom-compare-what-my-vault-says-about-neuroworks-to-the-cl | Custom | 150s | 27.1s | A- | 0 | **A-** |
| custom-give-me-a-summary-on-neuroworks | Custom | 150s | 12.1s | B+ | 0 | **B+** |
| custom-insurance-sales-agent-sell-auto-home-life-health-or-c | Custom | 150s | 57.3s | A- | 0 | **A-** |
...
| custom-clawbot-quick-web-look-up | Custom | 150s | 81.3s | A- | 0 | **A-** |
| custom-researcher-latest-news-scan-web-only | Custom | 150s | 168.7s | A- | 0 | **A-** |
...
- Both-clawbots-working: 219 samples across all phases
