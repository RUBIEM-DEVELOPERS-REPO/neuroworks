...
A short, scannable email that gets the recipient to act or understand in under 30 seconds of reading.
...
- **Length cap.** 150 words max for typical updates. Anything longer becomes a doc with a 3-line email pointing to it.
